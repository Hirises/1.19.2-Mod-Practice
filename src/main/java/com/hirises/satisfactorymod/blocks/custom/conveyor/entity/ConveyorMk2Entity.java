...
public class ConveyorMk2Entity extends ConveyorBaseEntity{
    public ConveyorMk2Entity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CONVEYOR_MK2.get(), pos, state, 10, 1, 5);
    }
    ...
    public Component getDisplayName() {
        return Component.translatable("gui.satisfactorymod.conveyor_mk2");
    }
